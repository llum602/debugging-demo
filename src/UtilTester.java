...
public class UtilTester {
    ...
    public void testBasicPositivePower() {
        ...
        assertEquals(125, MathUtils.raiseToPower(5, 3), delta);
    ...
    public void testShortUsername() {
        assertEquals("llum", StringUtils.makePurdueUsername("lauren", "lum"));
    }

//    @Test
//    public void testLongUsername() {
//        assertEquals("mdec", StringUtils.makePurdueUsername("maximus", "decimus-meridius"));
//    }

    @Test
    public void testUsernameCase() {
        assertEquals("llum", StringUtils.makePurdueUsername("lAuREn", "LUMmmmmmmMMMmmmmM"));
    }
